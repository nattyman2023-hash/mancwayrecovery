...
$page_title       = 'Areas We Cover — Mobile Mechanic Manchester | ' . site_name();
$page_description = 'MancWay mobile mechanics cover all of Greater Manchester: Manchester, Salford, Trafford, Stockport, Tameside, Bury, Bolton, Rochdale, Oldham and Wigan.';
...
<section class="page-hero">
    <div class="container">
        ...
        <p class="lead">Our mobile mechanics come to you across all of Greater Manchester. If you're not sure whether we cover your area, just <a href="<?= e(url('/contact.php')) ?>">give us a call</a>.</p>
    </div>
</section>
...
<section class="section">
    <div class="container">
        <?php if ($area): ?>
            ...
            <h2><?= e($area['name']) ?></h2>
            <p>We provide mobile mechanic services in <?= e($area['name']) ?> and surrounding postcodes: <?= e($area['postcodes']) ?>.</p>
            <p><a class="btn btn-primary" href="<?= e(url('/booking.php')) ?>">Book a mechanic in <?= e($area['name']) ?></a></p>
            <hr>
            ...
            <div class="grid grid-3">
                <?php foreach ($areas as $a): ?>
                    <article class="card area-card">
                        ...
                        <a class="btn btn-outline btn-block" href="<?= e(url('/booking.php')) ?>">Book in <?= e($a['name']) ?></a>
                    </article>
                <?php endforeach; ?>
            </div>
        <?php endif; ?>
